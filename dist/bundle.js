...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ToDoInput = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToDoInput = function ToDoInput(_ref) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toDoList = function toDoList() {
	    ...
	    switch (action.type) {
	        ...
	        case 'REMOVE_TODO':
	            return [].concat(_toConsumableArray(state.slice(0, action.id)), _toConsumableArray(state.slice(action.index + 1)));
	        case 'TOGGLE_TODO':
	            return state.map(function (i) {
	                return todo(i, action);
	            });
	        default:
	            return state;
	...
	var toDoReducer = (0, _redux.combineReducers)({
	    toDoList: toDoList,
	    visFilter: visFilter
	});
